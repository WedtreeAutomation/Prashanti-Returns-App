...
const apiService = {
    async getCustomerBalances(identifier: string, identifierType: 'email' | 'phone'): Promise<BalanceResponse> {
        ...
        console.log(`Searching for ${identifierType}: ${identifier}`);
...
const ReturnTrackingTab = ({ searchTerm, setSearchTerm, searchType, setSearchType, loading, handleSearch, error }: any) => (
    <div className="space-y-4">
        <div className="text-center mb-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl flex items-center justify-center mx-auto mb-2 shadow-lg">
        ...
        <form onSubmit={handleSearch}>
            <div className="flex flex-col sm:flex-row gap-2">
                <input
                    ...
                    className="flex-1 px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-pink-200 focus:border-pink-500 outline-none transition-all text-sm"
                    disabled={loading}
                />
                <button
                    type="submit"
                    disabled={loading}
                    className="sm:w-auto bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white font-medium px-4 py-2.5 rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg disabled:opacity-70 text-sm"
                >
                    {loading ? (
                        <>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between">
                        <Link to="/ReturnStatusPage" className="flex items-center gap-3 group">
                            <div className="w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all">
                                <PackageOpen className="w-6 h-6 text-white" />
                            </div>
                            <div>
                                <span className="font-bold text-xl text-slate-900">Prashanti</span>
                                <span className="text-pink-600 font-bold text-xl ml-1">Returns</span>
                            </div>
                        </Link>
                        <div className="flex items-center gap-4">
                            <Link
                                to="/CustomerPage"
                                className="flex items-center gap-2 text-pink-600 hover:text-pink-700 transition-colors px-4 py-2 rounded-lg hover:bg-pink-50"
                            >
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
                ...
                {(returnData || showSelection) && (
                    <button
                        onClick={handleBack}
                        className="lg:hidden flex items-center gap-1.5 text-pink-600 mb-4 font-medium text-sm"
                    >
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            {multipleReturns.map((ret) => (
                                <button
                                    ...
                                    className="w-full bg-slate-50 hover:bg-pink-50 border border-slate-200 rounded-lg sm:rounded-xl p-3 sm:p-4 flex items-center justify-between transition-all group"
                                >
                                    ...
                                    <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                                        ...
                                        <ChevronRight className="w-4 h-4 sm:w-5 sm:h-5 text-slate-400 group-hover:text-pink-600 transition-colors" />
                                    </div>
                                </button>
                            ))}
                        </div>
                            ...
                            <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200 shadow-lg overflow-hidden">
                                ...
                                <div className="p-4 sm:p-6 lg:p-8">
                                    ...
                                    <div className="bg-slate-50 rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-5">
                                        ...
                                        <p className="text-sm sm:text-base lg:text-lg font-bold text-pink-600 flex items-center gap-1.5 sm:gap-2">
                                    ...
                                    <div className="mt-6 sm:mt-8 bg-white border border-slate-200 rounded-xl sm:rounded-2xl overflow-hidden">
                                    ...
                                    {/* Contact Support */}
                                    <div className="mt-6 sm:mt-8 bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl sm:rounded-2xl border border-pink-100 p-4 sm:p-6">
                                        <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
                                            ...
                                            <div className="flex-1 w-full">
                                                ...
                                                <p className="text-sm sm:text-base text-pink-700 mb-3 sm:mb-4">{getContactMessage(returnData.status)}</p>
                                                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                                                    <a
                                                        href={`tel:9962505459`}
                                                        className="w-full sm:w-auto bg-white hover:bg-pink-50 text-pink-600 px-4 py-2.5 sm:py-2 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors text-sm"
                                                    >
