...
export const SelfShipModal = ({
  ...
  // Fetch warehouses from Firebase (same as CreatePickupModal)
  useEffect(() => {
  ...
  const sendSelfShipEmail = async (warehouse: Warehouse) => {
    try {
      // Format the warehouse address exactly as needed for the email template
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // Call onSuccess callback if provided (though not in props, we can add)
      onClose();
